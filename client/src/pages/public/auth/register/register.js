        ...
        <>
            ...
            <div className="register-form-inputs">
                ...
                <div className="register-form-inputs">
                    ...
                    <input type="tel" name="phone" placeholder="Format XX XX XX XX XX" pattern="[0-9]{2} [0-9]{2} [0-9]{2} [0-9]{2} [0-9]{2}" onChange={(e) => setPhone(e.target.value)} />
                </div>
                <div className="register-form-inputs">
                ...
                <div className="register-form-inputs">
                    ...
                    <input type="file" name="file" accept="image/jpeg, image/png" onChange={(e) => setAvatar(e.target.files)} />
                </div>
