      ...
      <section>
        ...
        <div className="articles-container">
          ...
          <article>
            ...
            <p>
              Vivamus vehicula massa eu rhoncus sagittis. Class aptent taciti
              sociosqu ad litora torquent per conubia nostra, per inceptos
              himenaeos. Proin at scelerisque lacus. Nullam vitae fringilla
              diam. Curabitur aliquam turpis in neque viverra, suscipit luctus
              ex euismod. Sed neque nisl, ultricies at ullamcorper ac, aliquet
              at velit. Mauris est purus, ornare eu turpis sed, hendrerit
              hendrerit ex. Etiam ut massa vel nisi vestibulum maximus. Nunc
              fringilla non tortor eget suscipit. Aliquam at tempus urna.
              Quisque nec enim arcu. Sed volutpat ultricies ligula dictum
              eleifend. Pellentesque id lorem aliquam, efficitur urna vel,
              blandit tellus. Duis condimentum odio nec ante venenatis, vitae
              porttitor arcu luctus. Vestibulum vel quam suscipit, interdum
              sapien ut, faucibus erat. Curabitur ut dui nec mi dignissim
              dignissim.
            </p>
          </article>
          {/* <article>
              ...
              {articles.map((article, i) => (
                <div key={i} className="article-container">
                  ...
                  <div className="link-button">
                    <Link to="/news" className="link-to-news-page">
                      Toutes mes actus 📰
                    </Link>
                  </div>
                </div>
