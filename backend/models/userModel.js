...
const userModel = new mongoose.Schema(
  {
    firstName: {
      ...
      required: [
        true,
        'Le champ "Prénom" est requis pour la création de compte, veuillez le remplir.',
      ],
    },
    lastName: {
      type: String,
      required: [
        true,
        'Le champ "Nom" est requis pour la création de compte, veuillez le remplir.',
      ],
    },
    email: {
      type: String,
      required: [
        true,
        'Le champ "Email" est requis pour la création de compte, veuillez le remplir.',
      ],
      unique: true,
    ...
    password: {
      ...
      required: [
        true,
        'Le champ "Mot de passe" est requis pour la création de compte, veuillez le remplir.',
      ],
    },
    isAdmin: {
      type: Boolean,
      default: function () {
        return (
          ...
          this.email === "fromont.ludivine@orange.fr"
        );
      },
    },
    avatar: {
